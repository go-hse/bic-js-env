...
import { lineNumbers, highlightActiveLineGutter, highlightSpecialChars, drawSelection, basicSetup, rectangularSelection, crosshairCursor, highlightActiveLine, keymap, EditorView } from '@codemirror/view';
...
export function Editor(parent, doc, options = {}) {
    const initialState = EditorState.create({ doc, extensions });
